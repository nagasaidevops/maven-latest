  ...
  <div class="row">
	<div class="col-lg-3 col-xs-6">
	  <div class="info-box"> <span class="info-box-icon bg-aqua"><i class="icon-briefcase"></i></span>
		<div class="info-box-content"> <span class="info-box-number">1234</span> <span class="info-box-text">Total Accounts</span> </div>
		<!-- /.info-box-content --> 
	  </div>
	  <!-- /.info-box --> 
	</div>
	...
	<div class="col-lg-3 col-xs-6">
	  <div class="info-box"> <span class="info-box-icon bg-green"><i class="icon-pencil"></i></span>
		<div class="info-box-content"> <span class="info-box-number">456</span> <span class="info-box-text">Total Contact</span></div>
		<!-- /.info-box-content --> 
	  </div>
	  <!-- /.info-box --> 
	</div>
	...
	<div class="col-lg-3 col-xs-6">
	  <div class="info-box"> <span class="info-box-icon bg-yellow"><i class="icon-wallet"></i></span>
		<div class="info-box-content"> <span class="info-box-number">41234</span> <span class="info-box-text">Total Oppurtunity</span></div>
		<!-- /.info-box-content --> 
	  </div>
	  <!-- /.info-box -->
	</div>
	...
	<div class="col-lg-3 col-xs-6">
	  <div class="info-box"> <span class="info-box-icon bg-red"><i class="icon-layers"></i></span>
		<div class="info-box-content"> <span class="info-box-number">84</span> <span class="info-box-text">Total Meetings</span></div>
		<!-- /.info-box-content --> 
	  </div>
	  <!-- /.info-box --> 
	</div>
